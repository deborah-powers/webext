...
function chooseAction (event){
	...
	chrome.tabs.query ({currentWindow: true, active: true}, function (tabs){
		...
		chrome.scripting.removeCSS ({
			...
			files: [
				'ana-common.css', 'elm-focus.css', 'elm-iframe.css', 'elm-image.css', 'elm-interract.css', 'elm-link.css', 'elm-structure.css', 'elm-table.css', 'elm-tooltip.css', 'text-spacing.css', 'text-spacing.css', 'text-widenning.css'
		]});
		var listStyle =[];
		var listScript =[];
		// choisir les actions
